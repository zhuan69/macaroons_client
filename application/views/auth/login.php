...
<html lang="id-ID">
    <head>
        ...
        <title>Macaroon Nice Dessert</title>
    ...
    <body>
        <h1>Login ke Macaroon Nice Dessert</h1>
        ...
        <footer>
            <p class="copyright-agileinfo"> &copy; 2021 </script> | Made with <i class="icon-heart text-danger" aria-hidden="true"></i> Admin Macaroon. </p>
        </footer>
