...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/slide-1.png'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Macaroon Terbaik</h1>
            <h2 class="subheading mb-4">Macaroon Nice Dessert Langsung dari Toko</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/slide-2.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Macaroon Tanpa Bahan Buatan</h1>
            <h2 class="subheading mb-4">Macaroon Nice Dessert Langsung dari Toko</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Selalu Enak dan Kenyal</h3>
          <span>Diproduksi Langsung dari Toko</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Kualitas dari Testimoni Terbaik</span>
        </div>
      </div>      
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
      ...
      <h2 class="mb-4">Toko Macaron</h2>
      <p>Belanja Macaron enak dan kenyal 24 jam</p>
    </div>
  </div>   		
  </div>
  <div class="container">
